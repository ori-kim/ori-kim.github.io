...
<div class="flex items-center gap-2">
  <img
    class="h-full w-1/2"
    alt="1-6"
    src="https://github.com/user-attachments/assets/3c2c7435-9993-48c2-83fd-cb2f43c4bea2"
  />
  <img class="h-full w-1/2" src="https://github.com/user-attachments/assets/ac193f42-e1bc-4def-bd05-7b103e5b9c9e" />
</div>
<div class="flex items-center gap-2">
  <img
    class="h-full w-1/2"
    alt="1-8"
    src="https://github.com/user-attachments/assets/1282eec0-e86a-44c4-90ab-11e6cae716be"
  />
  <img
    class="h-full w-1/2"
    alt="1-9"
    src="https://github.com/user-attachments/assets/d75932ce-620d-4130-8005-07ea418784d8"
  />
</div>
...
![caption:기존에 사용하던 페이지네이션 컴포넌트에 Query만 변경해 주입](https://github.com/user-attachments/assets/0058a0fd-b5dd-4dd2-85e6-408f3886f9b5)
